...
const webpackConfigAngular = proxyquire('./webpack.angular', {
    ...
    '@nativescript/webpack/transformers/ns-replace-lazy-loader': { nsReplaceLazyLoader: () => { return FakeLazyTransformerFlag } },
    '@nativescript/webpack/transformers/ns-support-hmr-ng': { nsSupportHmrNg: () => { return FakeHmrTransformerFlag } },
    '@nativescript/webpack/utils/ast-utils': { getMainModulePath: () => { return "fakePath"; } },
    '@nativescript/webpack/utils/tsconfig-utils': { getNoEmitOnErrorFromTSConfig: () => { return false; }, getCompilerOptionsFromTSConfig: () => { return false; } },
    '@nativescript/webpack/plugins/NativeScriptAngularCompilerPlugin': { getAngularCompilerPlugin: () => { return AngularCompilerStub; } },
    '@ngtools/webpack': {
